                ...
                static run(creep) {
                    ...
                    if (!resourceDeposit) {
                        ...
                        if (result == ERR_NOT_IN_RANGE)
                            ...
                            console.log('creep cannot gather resources : ' + result);
                        else
                            return true;
                    }
                    else {
                        ...
                        if (!tombId && Memory.tombstonesIds.includes(resourceDeposit.id))
                        ...
                        if (result == ERR_NOT_IN_RANGE) {
                            ...
                            console.log('creep cannot withdraw from source : ' + result);
                            return false;
                        }
                        if (tombId) {
                            if (resourceDeposit.store[RESOURCE_ENERGY] === 0)
                                console.log('♻️ A dead\'s creep tombstone has been plundered.');
                            delete creep.memory.gatheringStructureId;
